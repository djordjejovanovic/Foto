...
<body class="vertical-layout vertical-menu-modern dark-layout 1-column  navbar-floating footer-static bg-full-screen-image  blank-page blank-page" data-open="click" data-menu="vertical-menu-modern" data-col="1-column" data-layout="dark-layout">
                        ...
                        <div class="card bg-authentication rounded-0 mb-0">
                            <div class="row m-0">
                                <div class="col-lg-6 d-lg-block d-none text-center align-self-center px-1 py-0">
                                    <img src="../css/app-assets/images/pages/login.png" alt="branding logo">
                                </div>
  ...
  <!--                                        <c:if test="${!empty poruka }">
                                        <p class="px-2">${poruka }</p>
                                        </c:if>
                                        <p class="px-2">Welcome back, please login to your account.</p>-->
										<c:choose>
											<c:when test="${!empty poruka }">
										...
										<div class="card-content">
                                            <div class="card-body pt-1">
                                                <form action="/Foto/usercontroller/login" method="post">
                                                    ...
                                                    <a href="/Foto/login/registration.jsp" class="btn btn-outline-primary float-right btn-inline">Register</a>
                                                </form>
                                            </div>
                                        </div>
