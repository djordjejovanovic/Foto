...
<head>
    ...
    <!-- BEGIN: Vendor CSS-->
    <link rel="stylesheet" type="text/css" href="../css/app-assets/vendors/css/forms/spinner/jquery.bootstrap-touchspin.css">
...
<body class="horizontal-layout horizontal-menu dark-layout 2-columns  navbar-floating footer-static  " data-open="hover" data-menu="horizontal-menu" data-col="2-columns" data-layout="dark-layout">
    ...
    <script src="../css/app-assets/vendors/js/forms/spinner/jquery.bootstrap-touchspin.js"></script>
    ...
    <script src="../css/app-assets/js/scripts/forms/number-input.js"></script>
    <!-- END: Page JS-->
